...
void MessageSerializer::serialize(rapidxml::xml_node<>* parent, const BICEPS::PM::Range& range)
{
  ...
  {
    auto stepWidth = xmlDocument_->allocate_string(std::to_string(range.StepWidth.value()).c_str());
                                  ...
                                  const BICEPS::PM::AbstractMetricValue& value)
{
      ...
      numericValue != nullptr)
  {
    ...
    {
      auto num = xmlDocument_->allocate_string(std::to_string(numericValue->Value.value()).c_str());
